...
// table
__device__ static int			config_random_setRadius				(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_random_setParallel			(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_random_setRaySize			(void *object, uint8_t *data, uint32_t size);

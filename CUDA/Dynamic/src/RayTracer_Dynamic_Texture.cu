...
// table
__device__ static int			config_convolutor_setKernelSize		(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_convolutor_setKernelArray	(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_checkerboard_setBoardSize	(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_additor_setAdditor			(void *object, uint8_t *data, uint32_t size);
__device__ static int			config_multiplier_setMultiplier		(void *object, uint8_t *data, uint32_t size);

__device__ static int			interact_convolutor_setTexture		(void *object, void* *list, uint32_t size);
__device__ static int			interact_mapSphere_setSphere		(void *object, void* *list, uint32_t size);
__device__ static int			interact_dirSphere_setSphere		(void *object, void* *list, uint32_t size);
__device__ static int			interact_mapTrimesh_setTrimesh		(void *object, void* *list, uint32_t size);
__device__ static int			interact_dirTrimesh_setTrimesh		(void *object, void* *list, uint32_t size);

...
__host__ void RayTracer_Dynamic_Texture_init(std::vector<Dynamic_ContainerType*> *type_list) {
	// table
	Dynamic_CUDA_addTypeConfigLinker(convolutor, 	convolutor_setKernelSize);
	Dynamic_CUDA_addTypeConfigLinker(convolutor, 	convolutor_setKernelArray);
	Dynamic_CUDA_addTypeConfigLinker(checkerboard, 	checkerboard_setBoardSize);
	Dynamic_CUDA_addTypeConfigLinker(additor, 		additor_setAdditor);
	Dynamic_CUDA_addTypeConfigLinker(multiplier, 	multiplier_setMultiplier);

	Dynamic_CUDA_addTypeInteractLinker(convolutor,	convolutor_setTexture);
	Dynamic_CUDA_addTypeInteractLinker(mapSphere, 	mapSphere_setSphere);
	Dynamic_CUDA_addTypeInteractLinker(dirSphere, 	dirSphere_setSphere);
	Dynamic_CUDA_addTypeInteractLinker(mapTrimesh, 	mapTrimesh_setTrimesh);
	Dynamic_CUDA_addTypeInteractLinker(dirTrimesh, 	dirTrimesh_setTrimesh);
